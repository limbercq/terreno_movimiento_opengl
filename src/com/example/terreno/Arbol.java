...
public class Arbol {
	...
	private float vertices[] = new float[] {
			// Frente 
			-1-2+0.8f, -1, 1+2-0.8f, // 4 0
			1-2-0.8f, -1, 1+2-0.8f, // 5 1
			1-1-2, 1, 1-1+2, // 6 2
			-1+1-2, 1, 1-1+2, // 7 3
			// Atras
			-1+1-2, 1, -1+1+2, // 3 4
			1-1-2, 1, -1+1+2, // 2 5
			1-2-0.8f, -1, -1+2+0.8f, // 1 6
			-1-2+0.8f, -1, -1+2+0.8f, // 0 7
						
			// Izquierda 
			-1-2+0.8f ,-1, -1+2+0.8f, // 0 8 
			-1-2+0.8f, -1, 1+2-0.8f, // 4 9 
			-1+1-2, 1, 1-1+2, // 7 10 
			-1+1-2, 1, -1+1+2, // 3 11
			// Derecha
			1-2-0.8f, -1, 1+2-0.8f, // 5 12
			1-2-0.8f, -1, -1+2+0.8f, // 1 13
			1-1-2, 1, -1+1+2, // 2 14
			1-1-2, 1, 1-1+2, // 6 15
			// Abajo
			-1-2+0.8f, -1, -1+2+0.8f, // 0 16
			1-2-0.8f, -1, -1+2+0.8f, // 1 17
			1-2-0.8f, -1, 1+2-0.8f, // 5 18
			-1-2+0.8f, -1, 1+2-0.8f, // 4 19
			// Arriba
			-1+1-2, 1, 1-1+2, // 7 20
			1-1-2, 1, 1-1+2, // 6 21
			1-1-2, 1, -1+1+2, // 2 22
	...
	/* Los colores x c/vertice (r,g,b,a) */
