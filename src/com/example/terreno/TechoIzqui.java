...
public class TechoIzqui {
	...
	private float vertices[] = new float[] {
			...
			-1-2.5f, -1+2, 1-2, // 4 0
			1-2.5f, -1+2, 1-2, // 5 1
			1-0.3f-2.5f, 1+2-1, 1-0.3f-2, // 6 2
			-1+0.3f-2.5f, 1+2-1, 1-0.3f-2, // 7 3
			// Atr�s
			-1+0.3f-2.5f, 1+2-1, -1+0.3f-2, // 3 4
			1-0.3f-2.5f, 1+2-1, -1+0.3f-2, // 2 5
			1-2.5f, -1+2, -1-2, // 1 6
			-1-2.5f, -1+2, -1-2, // 0 7
			...
			-1-2.5f, -1+2, -1-2, // 0 8 
			-1-2.5f, -1+2, 1-2, // 4 9 
			-1+0.3f-2.5f, 1+2-1, 1-0.3f-2, // 7 10 
			-1+0.3f-2.5f, 1+2-1, -1+0.3f-2, // 3 11
			// Derecha
			1-2.5f, -1+2, 1-2, // 5 12
			1-2.5f, -1+2, -1-2, // 1 13
			1-0.3f-2.5f, 1+2-1, -1+0.3f-2, // 2 14
			1-0.3f-2.5f, 1+2-1, 1-0.3f-2, // 6 15
			// Abajo
			-1-2.5f, -1+2, -1-2, // 0 16
			1-2.5f, -1+2, -1-2, // 1 17
			1-2.5f, -1+2, 1-2, // 5 18
			-1-2.5f, -1+2, 1-2, // 4 19
			// Arriba
			-1+0.3f-2.5f, 1+2-1, 1-0.3f-2, // 7 20
			1-0.3f-2.5f, 1+2-1, 1-0.3f-2, // 6 21
			1-0.3f-2.5f, 1+2-1, -1+0.3f-2, // 2 22
			-1+0.3f-2.5f, 1+2-1, -1+0.3f-2 // 3 23
	};
