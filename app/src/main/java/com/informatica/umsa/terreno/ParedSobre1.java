...
public class ParedSobre1 {
	...
	private float vertices[] = new float[] {
			...
			-1+0.5f, -1, 1+0.3f, // 4 0
			1-0.5f, -1, 1+0.3f, // 5 1
			1-0.5f, 1-0.3f, 1+0.3f, // 6 2
			-1+0.5f, 1-0.3f, 1+0.3f, // 7 3
			// Atr�s
			-1+0.5f, 1-0.3f, -1-0.3f, // 3 4
			1-0.5f, 1-0.3f, -1-0.3f, // 2 5
			1-0.5f, -1, -1-0.3f, // 1 6
			-1+0.5f, -1, -1-0.3f, // 0 7
			...
			-1+0.5f, -1, -1-0.3f, // 0 8 
			-1+0.5f, -1, 1+0.3f, // 4 9 
			-1+0.5f, 1-0.3f,1+0.3f, // 7 10 
			-1+0.5f, 1-0.3f, -1-0.3f, // 3 11
			// Derecha
			1-0.5f, -1, 1+0.3f, // 5 12
			1-0.5f, -1, -1-0.3f, // 1 13
			1-0.5f, 1-0.3f, -1-0.3f, // 2 14
			1-0.5f, 1-0.3f, 1+0.3f, // 6 15
			// Abajo
			-1, -1, -1-0.3f, // 0 16
			1, -1, -1-0.3f, // 1 17
			1, -1, 1+0.3f, // 5 18
			-1, -1, 1+0.3f, // 4 19
			// Arriba
			-1, 1-0.3f, 1+0.3f, // 7 20
			1, 1-0.3f, 1+0.3f, // 6 21
			1, 1-0.3f, -1-0.3f, // 2 22
			-1, 1-0.3f, -1-0.3f // 3 23
	};
