...
public class ParedSobre {
	...
	private float vertices[] = new float[] {
			...
			-1-0.3f, -1, 1-0.5f, // 4 0
			1+0.3f, -1, 1-0.5f, // 5 1
			1+0.3f, 1-0.3f, 1-0.5f, // 6 2
			-1-0.3f, 1-0.3f, 1-0.5f, // 7 3
			// Atr�s
			-1-0.3f, 1-0.3f, -1+0.5f, // 3 4
			1+0.3f, 1-0.3f, -1+0.5f, // 2 5
			1+0.3f, -1, -1+0.5f, // 1 6
			-1-0.3f, -1, -1+0.5f, // 0 7
			...
			-1-0.3f, -1, -1+0.5f, // 0 8 
			-1-0.3f, -1, 1-0.5f, // 4 9 
			-1-0.3f, 1-0.3f,1-0.5f, // 7 10 
			-1-0.3f, 1-0.3f, -1+0.5f, // 3 11
			// Derecha
			1+0.3f, -1, 1-0.5f, // 5 12
			1+0.3f, -1, -1+0.5f, // 1 13
			1+0.3f, 1-0.3f, -1+0.5f, // 2 14
			1+0.3f, 1-0.3f, 1-0.5f, // 6 15
			// Abajo
			-1-0.3f, -1, -1, // 0 16
			1+0.3f, -1, -1, // 1 17
			1+0.3f, -1, 1, // 5 18
			-1-0.3f, -1, 1, // 4 19
			// Arriba
			-1-0.3f, 1-0.3f, 1, // 7 20
			1+0.3f, 1-0.3f, 1, // 6 21
			1+0.3f, 1-0.3f, -1, // 2 22
			-1-0.3f, 1-0.3f, -1 // 3 23
	};
