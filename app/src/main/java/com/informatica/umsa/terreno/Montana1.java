...
public class Montana1 {
	...
	private float vertices[] = new float[] {
			// Frente 
			-1-2-1.5f-3, -1, 1+2-1.5f+4, // 4 0
			1-2+1.5f-3, -1, 1+2-1.5f+4, // 5 1
			1-1-2-3, 1, 1-1+2+4, // 6 2
			-1+1-2-3, 1, 1-1+2+4, // 7 3
			// Atr�s
			-1+1-2-3, 1, -1+1+2+4, // 3 4
			1-1-2-3, 1, -1+1+2+4, // 2 5
			1-2+1.5f-3, -1, -1+2-1.5f+4, // 1 6
			-1-2-1.5f-3, -1, -1+2-1.5f+4, // 0 7
						
			// Izquierda 
			-1-2-1.5f-3 ,-1, -1+2-1.5f+4, // 0 8 
			-1-2-1.5f-3, -1, 1+2+1.5f+4, // 4 9 
			-1+1-2, 1-3, 1-1+2+4, // 7 10 
			-1+1-2, 1-3, -1+1+2+4, // 3 11
			// Derecha
			1-2+1.5f-3, -1, 1+2+1.5f+4, // 5 12
			1-2+1.5f-3, -1, -1+2-1.5f+4, // 1 13
			1-1-2-3, 1, -1+1+2+4, // 2 14
			1-1-2-3, 1, 1-1+2+4, // 6 15
			// Abajo
			-1-2-1.5f-3, -1, -1+2-1.5f+4, // 0 16
			1-2+1.5f-3, -1, -1+2-1.5f+4, // 1 17
			1-2+1.5f-3, -1, 1+2+1.5f+4, // 5 18
			-1-2-1.5f-3, -1, 1+2+1.5f+4, // 4 19
			// Arriba
			-1+1-2-3, 1, 1-1+2+4, // 7 20
			1-1-2-3, 1, 1-1+2+4, // 6 21
			1-1-2-3, 1, -1+1+2+4, // 2 22
			-1-1-2-3, 1, -1+1+2+4 // 3 23
	};
