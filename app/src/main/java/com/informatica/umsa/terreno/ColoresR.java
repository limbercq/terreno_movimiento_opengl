...
// Arriba
    ...
    public byte colorPlomo[] = new byte[]{
    		// Frente
    		            (byte) 128, (byte) 128, (byte) 128, maxColor, // 4 0
    		            (byte) 128, (byte) 128, (byte) 128, maxColor, // 4 0
    		            (byte) 128, (byte) 128, (byte) 128, maxColor, // 4 0
    		            (byte) 128, (byte) 128, (byte) 128, maxColor, // 4 0
    		// Atrás
    ...
    public byte colorCeleste[] = new byte[]{
    		// Frente
    		            (byte) 0, (byte) 255, (byte) 255, maxColor, // 4 0
    		            (byte) 0, (byte) 255, (byte) 255, maxColor, // 4 0
    		            (byte) 0, (byte) 255, (byte) 255, maxColor, // 4 0
    		            (byte) 0, (byte) 255, (byte) 255, maxColor, // 4 0
    		// Atrás
    ...
    public byte colorAzul[] = new byte[]{
    		// Frente
    		            (byte) 0, (byte) 0, (byte) 255, maxColor, // 4 0
    		            (byte) 0, (byte) 0, (byte) 255, maxColor, // 4 0
    		            (byte) 0, (byte) 0, (byte) 255, maxColor, // 4 0
    		            (byte) 0, (byte) 0, (byte) 255, maxColor, // 4 0
    		// Atrás
    ...
    public byte colorRojo[] = new byte[]{
    		// Frente
    		            (byte) 255, (byte) 0, (byte) 0, maxColor, // 4 0
    		            (byte) 255, (byte) 0, (byte) 0, maxColor, // 4 0
    		            (byte) 255, (byte) 0, (byte) 0, maxColor, // 4 0
    		            (byte) 255, (byte) 0, (byte) 0, maxColor, // 4 0
    		// Atrás
